<?php
/*
Plugin Name: Restrict Author Posting by Custom Taxonomy Term
Plugin URI: Propietary
Description: Allows you to restrict the taxonomy term that your site contributors can post to.
Author: Nzureuz & Luis Carlos Pando (@mijo)
Version: 1.0
Tags: restrict user, banned user, user role, posting to taxonomy term, specific posting taxonomy, author role
Author URI: http://luiscarlospando.net
*/

/*
Copyright 2015 Nzureuz, Mijo - (original source by Mcjambi)
...
*/
		...
		?>
			...
			<h3>Restrict the taxonomy in which this user can post to</h3>

			<table class="form-table">
				<tr>
					<th><label for="access">Select taxonomy term:</label></th>
		...
		/* auto register taxonomy to post that the author's being restricted */
		...
		/* remove taxonomy dropdown box in editor */
		/*Change # for the id of the taxonomy to hide*/
		function restrict_remove_meta_boxes() {
			if (is_restrict() ) {
				remove_meta_box('{$agencia}div', 'post', 'normal'); // Here goes the div name ID of the taxonomy metabox, in oder to hide it from the UI
			}
		}
